...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ TOZO X ☜\nFacebook: https://www.facebook.com/toji.fushiguroxd/nWhatsApp: +8801882333052",
    "admin": "He is TOZO X তাকে সবাই BOSS হিসেবে চিনে😘☺️",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌TOZO BOSS💖",
    ...
    "ki koros": "বস TOZO এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সব কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    "valo aso": "হ্যাঁ রে প্রিও, বস TOZO এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না…tozo বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস tozo x এর ChatBot 😏",
